...
import { MarketplaceRegistry as MarketplaceStore, MARKETPLACE_CACHE_DIR } from '../../core/marketplace/marketplace.js'
...
export function marketplaceCommand(): Command {
  ...
  cmd
    ...
    .action((opts: { dir: string; select?: string }) => {
      ...
      const cacheDir = path.join(opts.dir, MARKETPLACE_CACHE_DIR)
