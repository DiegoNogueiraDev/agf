...
const RUNNERS: Record<
  Exclude<GatePhase, 'connectivity' | 'adr-challenge'>,
...
export function runGate(
  ...
  const runner = RUNNERS[phase as Exclude<GatePhase, 'connectivity' | 'adr-challenge'>]
...
export function gateCommand(): Command {
  ...
  return new Command('gate')
    .description('Run phase-readiness gates (design, review, handoff, deploy, listening, all)')
