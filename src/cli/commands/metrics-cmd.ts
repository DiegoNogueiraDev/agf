      ...
      (opts: {
        ...
        try {
          ...
          if (opts.economyReport) {
            ...
            const note = savings.delegateEconomy
              ? `⚡ Modo delegate ativo — llm_tok=0 é esperado. CLI economy: ${savings.delegateEconomy.delegateSaved} tok economizados (${savings.delegateEconomy.savedPct}%).`
              : undefined
            out.ok({
