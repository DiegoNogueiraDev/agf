...
/**
 * Character class (regex source) of invisible/zero-width/bidi Unicode to neutralize. Single
 * source of truth \u2014 shared with config-injection-audit so both surfaces cover the same set,
 * including the Unicode Tags block U+E0000\u2013U+E007F (deprecated codepoints that encode invisible
 * ASCII, the "ASCII smuggler" prompt-injection vector; no legitimate use in agent input).
 */
