 ...
 * rebuilt (e.g. a host-only pack on
 * a Mac never rebuilds the windows .exe) or its upload fails — leaving the site
 * serving an old, wrong artifact for one channel while the others are current.
 *
