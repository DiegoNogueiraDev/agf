...
export function classifySectionTitle(title: string, level: number): { type: BlockType; confidence: number } {
  ...
  // AUDIT-001: an explicit task heading ("Task 1.1", "Tarefa 2", "Entregas")
  // must win over the level===1 epic fallback, otherwise a top-level `# Task 1.1`
  // is mis-typed as an epic.
