...
export class PolicyEngine {
  ...
  static defaultRules(): PolicyRule[] {
    return [
      {
        name: 'import_prd',
        // Import só quando o grafo está VAZIO. O `hasRequirements: false` anterior
        // re-importava para sempre quando o PRD gerava tasks-sem-requirement
        // (node_1ffe8eb1c7b9): a máquina de estados nunca chegava a implement.
        condition: { emptyGraph: true },
