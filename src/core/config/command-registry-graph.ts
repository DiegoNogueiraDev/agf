...
export const REGISTRY_GRAPH: CommandDescriptor[] = [
  ...
  { name: 'build', description: 'Lifecycle completo: PRD → grafo → decompose → autopilot', category: 'front-door' },
  {
    ...
    usage: '[--simulate|--live|--max <n>|--retries <n>|--gate-gaps|--heal-on-fail|--swarm]',
    category: 'front-door',
  },
  {
    name: 'ant',
    description:
      'Colônia worktree-por-formiga: spawnar/listar/remover formigas, cada uma num worktree isolado no MESMO grafo central',
    usage: 'spawn <id> | list | rm <id>',
  ...
  },
  {
    ...
    parent: 'ant',
    description:
      'Spawnar uma formiga: cria (ou reusa) seu worktree em <repo>-ants/<id> e devolve os exports (AGF_AGENT_ID, AGF_GRAPH_ROOT)',
    category: 'dev-tooling',
  },
  {
    name: 'list',
    parent: 'ant',
    description: 'Lista as formigas (worktrees) vivas da colônia',
    category: 'dev-tooling',
  },
  {
    name: 'rm',
    parent: 'ant',
    description: 'Remove o worktree de uma formiga (a branch ant/<id> é preservada)',
    category: 'dev-tooling',
  },
  {
    name: 'loop',
