...
const CertaintyPanel = lazy(() =>
  import('@/components/tabs/certainty-panel').then((m) => ({ default: m.CertaintyPanel })),
)
const OkrTab = lazy(() => import('@/components/tabs/okr-tab').then((m) => ({ default: m.OkrTabContainer })))
...
function AppContent(): React.JSX.Element {
  // Abre em Colony: 'graph' continua sendo um destino válido (URL/localStorage
  // antigos), mas deixou de ter entrada na sidebar — iniciar nele deixaria a
  // navegação sem item ativo (node_5f912ff675bb).
          ...
          >
            <ErrorBoundary key={activeTab}>
              <Suspense fallback={<LoadingFallback />}>
                ...
                {activeTab === 'certainty' && <CertaintyPanel />}
