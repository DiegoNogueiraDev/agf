...
describe('<Breadcrumb>', () => {
  ...
  it("clicking the group segment navigates to the group's first tab", async () => {
    ...
    // O primeiro item do grupo passou a ser Colony: a entrada 'Graph' saiu da
    // sidebar por ser porta duplicada da mesma árvore (node_5f912ff675bb).
    expect(onTabChange).toHaveBeenCalledWith('colony')
  })
