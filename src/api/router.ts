...
import { createColonyRouter } from './routes/colony.js'
import { createOkrRouter } from './routes/okr.js'
import { createEdgesRouter } from './routes/edges.js'
import { createStatsRouter } from './routes/stats.js'
import { createEconomyRouter } from './routes/economy.js'
import { createCertaintyRouter } from './routes/certainty.js'
...
export function createApiRouter(options: ApiRouterOptions): Router {
  ...
  router.use('/colony', createColonyRouter(store))
  router.use('/okr', createOkrRouter(store))
  ...
  router.use('/certainty', createCertaintyRouter(store))
  router.use('/health', createHealthRouter(store))
  router.use('/events', createEventsSseRouter(store))
