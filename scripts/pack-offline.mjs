 ...
 *   4. rename → dist-offline/agf-offline-<platform>-<arch>-<version>.tgz
...
const packedName = `agf-offline-${platform}-${arch}-${version}.tgz`
...
writeFileSync(join(OUT, 'ABI'), `${process.versions.modules}\n`)
