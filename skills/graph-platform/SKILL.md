...
| --------------------------- | --------------------------------------- |
| `agf harness`               | Agent-readiness (8 dimensions, A/B/C/D) |
...
1. Harness Scan — `agf harness` (8 dims: type coverage, test coverage, architecture fitness, docs, naming, error handling, context density, provenance)
